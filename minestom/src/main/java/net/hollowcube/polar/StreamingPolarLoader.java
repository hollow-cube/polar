...
import net.hollowcube.polar.buffer.MinestomBufferWrapper;
...
import static net.hollowcube.polar.buffer.MinestomBufferWrapper.LIGHT_DATA;
    ...
    private void readChunk(@NotNull NetworkBuffer buffer, int minSection, int maxSection) {
        ...
        synchronized (chunk) {
            ...
            for (int i = 0; i < blockEntityCount; i++) {
                final var blockEntity = readBlockEntity(dataConverter, version, dataVersion, new MinestomBufferWrapper(buffer));
            ...
            int[][] heightmaps = readHeightmapData(new MinestomBufferWrapper(buffer), worldAccess == null);
